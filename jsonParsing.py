...
# get me the first language taught by Rahul Shetty
...
with open('C:\\Users\\vtadimet\\Downloads\\course.json') as f:
    data = json.load(f)
    print(data)
    print(type(data))
...
with open('C:\\Users\\vtadimet\\Downloads\\course1.json') as fi:
    data2 = json.load(fi)
    assert data == data2